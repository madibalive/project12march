...
public class SearchGossipCell extends SimpleCell<MdGossip, SearchGossipCell.ViewHolder>
  implements Updatable<MdGossip> {

  private static final String KEY_TITLE = "KEY_TITLE";
  private boolean showHandle;

  public SearchGossipCell(MdGossip item) {
    super(item);
  }
...
//      if (payload instanceof MdGossip) {
//        holder.textView.setText(((MdGossip) payload).getTitle());
//      }
//      // payloads from updateCells()
//      if (payload instanceof ArrayList) {
//        List<MdGossip> payloads = ((ArrayList<MdGossip>) payload);
...
//    }
  ...
  private void BindView(ViewHolder holder,MdGossip item){
...
//    return getItem().getObjectId().equals(newItem.getObjectId());
   ...
   */
  @Override
  public Object getChangePayload(MdGossip newItem) {
