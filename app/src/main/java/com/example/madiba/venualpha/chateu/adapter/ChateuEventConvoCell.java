...
public class ChateuEventConvoCell extends SimpleCell<MConversationItem, ChateuEventConvoCell.ViewHolder>
  implements Updatable<MConversationItem> {

  private static final String KEY_TITLE = "KEY_TITLE";
  private boolean showHandle;

  public ChateuEventConvoCell(MConversationItem item) {
    super(item);
  }
