...
public class CommentActivityFragment extends DialogFragment {
    ...
    public static CommentActivityFragment newInstance(String toId, String toClass, boolean fromViewer) {
