...
public class SearchAdapter extends BaseQuickAdapter<SearchModel> {
    ...
    protected BaseViewHolder onCreateDefViewHolder(ViewGroup parent, int viewType) {
        if (viewType == SearchModel.PEOPLE){
            return new PeopleViewHolder(getItemView(R.layout.container_box_header, parent));
        }
        else if (viewType == SearchModel.GOSSIP){
            return new GossipViewHolder(getItemView(R.layout.container_box_header, parent));
        }
        else if (viewType == SearchModel.EVENT){
            return new EventsViewHolder(getItemView(R.layout.container_box_header, parent));
        }else {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position, List<Object> payloads) {
        ...
        if (holder instanceof PeopleViewHolder) {
            ...
            TextView t = ((PeopleViewHolder) holder).getView(R.id.box_title);
            t.setText("Users found");
            RecyclerView rview = ((PeopleViewHolder) holder).getView(R.id.box_recyclerview);
            ...
            RecyclerView rview = ((GossipViewHolder) holder).getView(R.id.box_recyclerview);
            TextView t = ((GossipViewHolder) holder).getView(R.id.box_title);
            ...
            RecyclerView rview = ((EventsViewHolder) holder).getView(R.id.box_recyclerview);
            TextView t = ((EventsViewHolder) holder).getView(R.id.box_title);
            ...
            rview.setAdapter(mAdapter);
            mAdapter.setOnRecyclerViewItemClickListener((view, i) -> {
                SingletonDataSource.getInstance().setEventPageEvent(mAdapter.getItem(i));
                NavigateTo.goToEventPage(mContext,mAdapter.getItem(i).getObjectId(),mAdapter.getItem(i).getClassName(),n.getData().get(i).getInt("theme"));
            });
