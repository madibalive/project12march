...
public class ModelFeedItem  {
    ...
    public static final int TYPP_PROMOTED=5;
    ...
    // PROMOTED
    private List<ParseObject> promotedContents=new ArrayList<>();
    ...
    public List<ParseObject> getPromotedContents() {
        return promotedContents;
    }

    public void setPromotedContents(List<ParseObject> promotedContents) {
        this.promotedContents = promotedContents;
    }
}
