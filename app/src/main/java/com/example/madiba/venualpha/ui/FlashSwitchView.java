...
public class FlashSwitchView extends ImageButton {
    ...
    public FlashSwitchView(@NonNull Context context, AttributeSet attrs) {
        super(context, attrs);
        flashOnDrawable = ContextCompat.getDrawable(context, R.drawable.ic_add);
        flashOffDrawable = ContextCompat.getDrawable(context, R.drawable.ic_add_new_event);
        flashAutoDrawable = ContextCompat.getDrawable(context, R.drawable.ic_add);
        init();
    }
