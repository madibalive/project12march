...
public class CreateGossipDailog extends BottomSheetDialogFragment {
...
//    private Listener mListener;
    ...
    public static CreateGossipDailog newInstance() {
        return new CreateGossipDailog();
    }
    ...
    private void displayColors() {
        ...
        for (final int feature : mColors) {
            ...
            ViewUtils.setHeightAndWidth(circleView,(int)(size.x/9),(int)(size.x/9));
            ViewUtils.setMargins(circleView,5,5,5,5);
