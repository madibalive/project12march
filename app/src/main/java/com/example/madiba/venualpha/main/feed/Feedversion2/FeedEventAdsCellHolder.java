...
public class FeedEventAdsCellHolder extends SimpleCell<MdTrendEvents, FeedEventAdsCellHolder.ViewHolder>
{

  public FeedEventAdsCellHolder(MdTrendEvents item) {
    super(item);
  }
