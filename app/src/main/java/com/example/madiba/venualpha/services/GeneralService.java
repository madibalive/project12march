...
public class GeneralService extends IntentService {
    ...
    public static void startActionSetGoing(Context context, String id, String className,int type, @Nullable String name,@Nullable int phone) {
        Intent intent = new Intent(context, GeneralService.class);
        ...
        if (phone == 0)
            intent.putExtra("className", phone);
        context.startService(intent);
    }
