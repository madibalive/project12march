...
public class SearchUserCell extends SimpleCell<MdUserItem, SearchUserCell.ViewHolder>
  implements Updatable<MdUserItem> {
...
//      if (payload instanceof MdUserItem) {
//        holder.textView.setText(((MdUserItem) payload).getTitle());
//      }
//      // payloads from updateCells()
//      if (payload instanceof ArrayList) {
//        List<MdUserItem> payloads = ((ArrayList<MdUserItem>) payload);
...
//    }
  ...
  private void BindView(ViewHolder holder,MdUserItem item){
...
//    return getItem().getObjectId().hashCode();
   ...
   */
  @Override
  public boolean areContentsTheSame(MdUserItem newItem) {
//    return getItem().getObjectId().equals(newItem.getObjectId());
   ...
   */
  @Override
  public Object getChangePayload(MdUserItem newItem) {
