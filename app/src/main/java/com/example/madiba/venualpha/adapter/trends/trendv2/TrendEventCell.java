...
public class TrendEventCell extends SimpleCell<MdEventItem, TrendEventCell.ViewHolder>
{

  public TrendEventCell(MdEventItem item) {
    super(item);
  }
  ...
  protected void onBindViewHolder(ViewHolder holder, int position, Context context, Object payload) {
    ...
    ViewUtils.setHeightAndWidth(viewGroup,340,270);
  }
