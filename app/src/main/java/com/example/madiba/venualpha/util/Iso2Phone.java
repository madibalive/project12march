...
/**
 * Created by Madiba on 3/21/2017.
 */
...
public class Iso2Phone
{
    ...
    {
        String code =  country_to_indicative.get(data.toUpperCase());
        List<String> indexes = new ArrayList<String>(country_to_indicative.keySet()); // <== Parse

        return indexes.indexOf(code);
    }

    public static LinkedHashMap<String, String> country_to_indicative = new LinkedHashMap<String, String>();
    static
    {
