...
import com.example.madiba.venualpha.channels.LoaderChannel;
...
import static com.example.madiba.venualpha.R.string.event;
...
public class MainChannelActivity extends FragmentActivity {
    ...
    private void requestOpen(int type){
        switch (type){
            case GlobalConstants.CHANNEL_TYPE_OTHER:
                break;
            default:
                modeTwo();
        }
