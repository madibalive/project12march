...
public class FeedMemoryCell extends SimpleCell<MdMemoryItem, FeedMemoryCell.ViewHolder>
        implements Updatable<MdMemoryItem> {

  private static final String KEY_TITLE = "KEY_TITLE";
  private boolean showHandle;

  public FeedMemoryCell(MdMemoryItem item) {
    super(item);
  }

  @Override
  protected int getLayoutRes() {
    return R.layout.item_feed_memory;
  }
