...
public class Camera2Controller implements CameraController<String>,
    ...
    public void toggleEffect(int a) {
        ...
        switch (a){
            case 0:
                number=CaptureRequest.CONTROL_EFFECT_MODE_SEPIA;
                break;
            case 1:
                number=CaptureRequest.CONTROL_EFFECT_MODE_MONO;
                break;
            case 2:
                number=CaptureRequest.CONTROL_EFFECT_MODE_POSTERIZE;
                break;
            case 3:
                number=CaptureRequest.CONTROL_EFFECT_MODE_AQUA;
                break;
            default:
                number=CaptureRequest.CONTROL_EFFECT_MODE_OFF;
                break;
        }

        camera2Manager.handleParameters(new ParametersHandler<CaptureRequest.Builder>() {
            @Override
            public CaptureRequest.Builder getParameters(CaptureRequest.Builder cameraParams) {
                cameraParams.set(CaptureRequest.CONTROL_EFFECT_MODE,number);
                return cameraParams;
            }
        });
    }
