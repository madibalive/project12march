...
public class PreviewActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    static final int REQ_CODE_CSDK_IMAGE_EDITOR = 3002;
    ...
    private void showImagePreview() {
        ...
        editImage.setOnClickListener(view -> openEditor());
    }
...
//            resultIntent.putExtra(RESPONSE_CODE_ARG, BaseAnncaActivity.ACTION_CONFIRM).putExtra(FILE_PATH_ARG, previewFilePath).putExtra(AnncaConfiguration.Arguments.IS_VIDEO,isVideo);
            resultIntent.putExtra(RESPONSE_CODE_ARG, BaseAnncaActivity.ACTION_CONFIRM).putExtra(FILE_PATH_ARG, previewFilePath);
            Log.e("PICKER", "ONCLICK: OK " +  previewFilePath);
    ...
    private void openEditor() {
        try {
            ...
            Log.i("EDITOR", "openEditor: " + e.getMessage());
        }
