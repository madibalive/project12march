...
public final class AnncaConfiguration {
    ...
    public interface Arguments {
        ...
        String GALLERY_FILE_PATH = "io.memfis19.annca.camera_gallery_file_path";
        String IS_VIDEO = "io.memfis19.annca.is_video_boolean";
    }
    ...
    public int getRequestCode() {
        Log.e("PICKER", "getRequestCode:" +requestCode );
        return requestCode;
    }
